...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary via-primary/95 to-secondary/30 p-4">
      <motion.div
        ...
        <Card className="border-border shadow-2xl backdrop-blur-sm bg-background/95">
          ...
          <CardContent className="space-y-6">
            <Button
              ...
              disabled={isLoading}
              className="w-full bg-white hover:bg-gray-50 text-gray-900 border border-gray-300 h-14 text-base font-medium"
            >
              {isLoading ? (
